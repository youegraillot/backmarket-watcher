...
const botCommands = [
  {
    ...
    description: "Activate alert for unchanged price.",
  },
  {
    command: "show_decrease",
    description: "Activate alert for decreasing price.",
  },
  {
  ...
  },
  {
    ...
    description: "Activate alert for increasing price.",
  },
  {
    command: "show_increase_from_zero",
    description: "Activate alert for new price available.",
  },
  {
    command: "start",
...
function startCommand(context) {
  ...
  context
    .reply(
      `👋 I am the BackMarket bot.
🚨 I will tell you whenever the prices of your products changes.
